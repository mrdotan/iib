 ...
 * 标准MAC算法。
 * 
 * @author Liang Yabao 2012-4-13
 */
public class MacEncrypt extends Des {
	 ...
	 * 
	 * @param data
	 *            数据，先转换成16进制字符串表示，再填充成为16的整数倍长度
	 * 
	 * @return mac
	 */
	...
	public static void main(String[] args) throws Exception {
		// System.out.println("LON CHO : " + mac("3132333435363733", null,
		// "THE NAO, ad", ASC));

		// JCESecurityModule a = new JCESecurityModule();
		// EncryptedPIN tan= a.encryptPIN("3132333435363733",
		// "3132333435363733");
		// System.out.println(tan);
		// iso8583 dao = new iso8583();
		// System.out.println(iso8583.("3132333435363733", ASC));
	}
